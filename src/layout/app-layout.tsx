...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'astrologer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Chats', path: '/chats', entity: 'chat', service: AccessServiceEnum.PROJECT, icon: FiMessageCircle },
    { name: 'Readings', path: '/readings', entity: 'reading', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
