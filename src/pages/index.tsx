...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Milkyway Astrology`}</title>

        <meta
          name="description"
          content="Milkyway Astrology: Discover your cosmic footprint with our Vedic Astrology App. Get your free birthchart, schedule readings, and chat with our AI about astrology."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1515942661900-94b3d1972591?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhc3Ryb2xvZ3l8ZW58MHx8fHwxNjk2NzkxMDI0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@jsr1?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Josh Rangel`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Milkyway Astrology: Discover your cosmic footprint with our Vedic Astrology App. Get your free birthchart, schedule readings, and chat with our AI about astrology.`}
            </Text>
            <Box
