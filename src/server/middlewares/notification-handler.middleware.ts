...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'astrologer_update_readings.update': {
    roles: ['owner'],
    key: 'astrologer_update_readings',
    tenantPath: [],
    userPath: [],
  },
  'guest_book_consultation.create': {
    roles: ['owner', 'astrologer'],
    key: 'guest_book_consultation',
    tenantPath: [],
    userPath: [],
  },
  'astrologer_cancel_consultation.delete': {
    roles: ['owner'],
    key: 'astrologer_cancel_consultation',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'astrologer'];
